...
class MitarbeiterAdmin(admin.ModelAdmin):
    list_display = ['nachname', 'vorname', 'geburtstag',
                    'bild', 'email', 'beschreibung', 'is_active', 'check']
    list_filter = ['is_active']
...
class StandortAdmin(admin.ModelAdmin):
    list_display = ['standort', 'strasse', 'raum',
                    'beschreibung', 'is_active', 'check']
    list_filter = ['is_active']
...
class Zt2t_ma2ro2ve2ko2reAdmin(admin.ModelAdmin):
    list_display = ['t2t_mitarbeiter', 't2t_rolle', 't2t_verfahren',
                    't2t_komponente', 't2t_remedy', 'is_active', 'check']
